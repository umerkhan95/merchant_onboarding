...
# Fields that add value (price, image, description, sku)
...
class QualityScorer:
    ...
    Does not modify data or have side effects.
    """
    ...
    def score_product(self, product: dict) -> float:
        ...
        Scoring:
            - 0.0 if no title/name found (unusable)
